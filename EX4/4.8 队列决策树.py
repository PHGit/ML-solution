...
class DecisionTree(object):
    ...
    def tree_generate(self, data_set, feature_dict):
        ...
        while len(queue):
            ...
            if (element_data_set.pure_class() != -1) or (len(element_data_set.class_set) == 0)  or (queue_element.current_depth >= max_deepth):
                # print len(queue)
                ...
                for feat in feat_set:
                    ...
                    if sub_data_set.num == 0:  # 如果子数据集为空
                        ...
                        new_queue_element = Queue_Element(sub_data_set, queue_element.current_depth + 1, new_node)
